...
## Nguồn cào tin (chỉ dùng WebFetch, KHÔNG dùng Chrome → tự động 100%)
- Biến động 33 ngành: `https://www.traders.co.jp/market_jp/sector_ranking/day` (nguồn gốc `my.kabumap.com` render JS, WebFetch không đọc được).
- Mã giao dịch đột biến: `https://www.nikkei.com/marketdata/ranking-jp/spike-in-trading-value/`.
